		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<a class="navbar-brand" href="index.php"><img src="images/logo.png" alt=""><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a>
				</div>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>HOTEL MARINA INTERNATIONAL LTD</h4>
